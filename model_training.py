...
model_file = 'models/xgb_one_item_400.pickle'
st = time.time()
...
model_file = 'models/lstm_one_item_400.pickle'
st = time.time()
...
model_file = 'models/cnn_one_item_400.pickle'
st = time.time()
...
model_file = 'models/forest_one_item_400.pickle'
st = time.time()
...
model_file = 'models/xgb_many_item_400.pickle'
st = time.time()
...
model_file = 'models/lstm_many_item_400.pickle'
st = time.time()
...
model_file = 'models/cnn_many_item_400.pickle'
st = time.time()
...
model_file = 'models/forest_many_item_400.pickle'
st = time.time()
...
print(df1)
df1.to_excel("output/" + "table_models_400.xlsx")
