...
columns = ['productIds', 'MSE_no_transfer', 'MSE_transfer_basic', 'MSE_transfer_rt', 'MAE_no_transfer','MAE_transfer_basic','MAE_transfer_rt',
           'MSE_diff_basic','MSE_diff_rt','MAE_diff_basic','MAE_diff_rt']
